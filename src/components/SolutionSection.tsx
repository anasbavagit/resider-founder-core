    ...
    <section id="solution" ref={ref} className="section-padding section-y bg-primary text-primary-foreground">
      <div className="max-container">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Resider is the strategic answer to fragmented setup and execution. We
            allocate the right expert support across your full setup and early
            operational journey — from residency and structuring, through
            compliance and banking, to early execution. One trusted layer,
            precision-matched to what you're building.
          </p>
          <div
